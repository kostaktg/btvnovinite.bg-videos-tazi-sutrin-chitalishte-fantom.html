...
<h2>Добавяне на нов Колектив</h2>
<form enctype="multipart/form-data" action="{{URL(route('storeblog'))}}" method="POST">
 ...
 {{ csrf_field() }}
  <div class="form-group">
    ...
    <select name="type" id="type" >
      <option value="0">Постоянно действащи</option>
      <option value="1">Временно действащи</option>
    </select>
  </div>
  <div class="form-group">
